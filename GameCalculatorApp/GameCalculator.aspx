        ...
        <asp:Panel ID="GameInfoControlPanel" runat="server" BackColor="#403E7F">
            ...
            <div class="row">
                <div class="col-xs-6 col-sm-3" id="Column1">
                    <div class="well">
                        <div class="text-center">
                            <asp:Label ID="Game1Label" runat="server" Text="GAME 1" Font-Bold="True" ForeColor="#F96C07" CssClass="text-center"></asp:Label>
                        </div>
                        <div class="form-group">
                            <asp:Label ID="ResultLabel1" class="control-label" runat="server" Text="Result:"></asp:Label>
                            <asp:RadioButtonList ID="ResultRadioButtonList1" runat="server" RepeatDirection="Horizontal" ToolTip="Please select a result option to continue." CellPadding="1" CellSpacing="1" CssClass="text-center" TextAlign="Right">
                        ...
                        <div class="form-group">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Valid score must be entered." ControlToValidate="ScoreTextBox1" CssClass="alert-danger" Display="Dynamic" Font-Bold="True"></asp:RequiredFieldValidator>
                            <asp:RangeValidator ID="ScoreRangeValidator1" runat="server" ErrorMessage="Score number must be 0 or greater." ControlToValidate="ScoreTextBox1" CssClass="alert-danger" Display="Dynamic" Font-Bold="True" MaximumValue="999999999" MinimumValue="0" Type="Integer"></asp:RangeValidator>
                        </div>
                        <div class="form-group">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Valid number required for points allowed." ControlToValidate="AllowedTextBox1" CssClass="alert-danger" Display="Dynamic" Font-Bold="True"></asp:RequiredFieldValidator>
                            <asp:RangeValidator ID="AllowedRangeValidator1" runat="server" ErrorMessage="Allowed points number must be 0 or greater." ControlToValidate="AllowedTextBox1" CssClass="alert-danger" Display="Dynamic" Font-Bold="True" MaximumValue="999999999" MinimumValue="0" Type="Integer"></asp:RangeValidator>
                            <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="Points scored/allowed cannot be the same number. " ControlToCompare="ScoreTextBox1" ControlToValidate="AllowedTextBox1" CssClass="alert-danger" Display="Dynamic" Font-Bold="True" Operator="NotEqual" ValueToCompare="ScoreTextBox1"></asp:CompareValidator>
                        </div>
                        <div class="form-group">
                ...
                <div class="col-xs-6 col-sm-3" id="Column2">
                    <div class="well">
                        ...
                        <div class="form-group">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Valid score must be entered." ControlToValidate="ScoreTextBox2" CssClass="alert-danger" Display="Dynamic" Font-Bold="True"></asp:RequiredFieldValidator>
                            <asp:RangeValidator ID="RangeValidator1" runat="server" ErrorMessage="Score number must be 0 or greater." ControlToValidate="ScoreTextBox2" CssClass="alert-danger" Display="Dynamic" Font-Bold="True" MaximumValue="999999999" MinimumValue="0" Type="Integer"></asp:RangeValidator>
                        </div>
                        <div class="form-group">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Valid number required for points allowed." ControlToValidate="AllowedTextBox2" CssClass="alert-danger" Display="Dynamic" Font-Bold="True"></asp:RequiredFieldValidator>
                            <asp:RangeValidator ID="RangeValidator2" runat="server" ErrorMessage="Allowed points number must be 0 or greater." ControlToValidate="AllowedTextBox2" CssClass="alert-danger" Display="Dynamic" Font-Bold="True" MaximumValue="999999999" MinimumValue="0" Type="Integer"></asp:RangeValidator>
                            <asp:CompareValidator ID="CompareValidator2" runat="server" ErrorMessage="Points scored/allowed cannot be the same number." ControlToCompare="ScoreTextBox2" ControlToValidate="AllowedTextBox2" CssClass="alert-danger" Display="Dynamic" Font-Bold="True" Operator="NotEqual" ValueToCompare="ScoreTextBox1"></asp:CompareValidator>
                        </div>
                        <div class="form-group">
                ...
                <div class="col-xs-6 col-sm-3" id="Column3">
                    <div class="well">
                        ...
                        <div class="form-group">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="Valid score must be entered." ControlToValidate="ScoreTextBox3" CssClass="alert-danger" Display="Dynamic" Font-Bold="True"></asp:RequiredFieldValidator>
                            <asp:RangeValidator ID="RangeValidator4" runat="server" ErrorMessage="Score number must be 0 or greater." ControlToValidate="ScoreTextBox3" CssClass="alert-danger" Display="Dynamic" Font-Bold="True" MaximumValue="999999999" MinimumValue="0" Type="Integer"></asp:RangeValidator>
                        </div>
                        <div class="form-group">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="Valid number required for points allowed." ControlToValidate="AllowedTextBox3" CssClass="alert-danger" Display="Dynamic" Font-Bold="True"></asp:RequiredFieldValidator>
                            <asp:RangeValidator ID="RangeValidator5" runat="server" ErrorMessage="Allowed points number must be 0 or greater." ControlToValidate="AllowedTextBox3" CssClass="alert-danger" Display="Dynamic" Font-Bold="True" MaximumValue="999999999" MinimumValue="0" Type="Integer"></asp:RangeValidator>
                            <asp:CompareValidator ID="CompareValidator3" runat="server" ErrorMessage="Points scored/allowed cannot be the same number." ControlToCompare="ScoreTextBox3" ControlToValidate="AllowedTextBox3" CssClass="alert-danger" Display="Dynamic" Font-Bold="True" Operator="NotEqual" ValueToCompare="ScoreTextBox3"></asp:CompareValidator>
                        </div>
                        <div class="form-group">
                ...
                <div class="col-xs-6 col-sm-3" id="Column4">
                    <div class="well">
                        ...
                        <div class="form-group">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ErrorMessage="Valid score must be entered." ControlToValidate="ScoreTextBox4" CssClass="alert-danger" Display="Dynamic" Font-Bold="True"></asp:RequiredFieldValidator>
                            <asp:RangeValidator ID="RangeValidator7" runat="server" ErrorMessage="Score number must be 0 or greater." ControlToValidate="ScoreTextBox4" CssClass="alert-danger" Display="Dynamic" Font-Bold="True" MaximumValue="999999999" MinimumValue="0" Type="Integer"></asp:RangeValidator>
                        </div>
                        <div class="form-group">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ErrorMessage="Valid number required for points allowed." ControlToValidate="AllowedTextBox4" CssClass="alert-danger" Display="Dynamic" Font-Bold="True"></asp:RequiredFieldValidator>
                            <asp:RangeValidator ID="RangeValidator8" runat="server" ErrorMessage="Allowed points number must be 0 or greater." ControlToValidate="AllowedTextBox4" CssClass="alert-danger" Display="Dynamic" Font-Bold="True" MaximumValue="999999999" MinimumValue="0" Type="Integer"></asp:RangeValidator>
                            <asp:CompareValidator ID="CompareValidator4" runat="server" ErrorMessage="Points scored/allowed cannot be the same number." ControlToCompare="ScoreTextBox4" ControlToValidate="AllowedTextBox4" CssClass="alert-danger" Display="Dynamic" Font-Bold="True" Operator="NotEqual" ValueToCompare="ScoreTextBox4"></asp:CompareValidator>
                        </div>
                        <div class="form-group">
        ...
        <asp:Panel ID="GamesSummaryPanel" runat="server" Visible="False" BackColor="#F96C07" ForeColor="#F96C07">
            <div class="container-fluid">
                <div class="panel panel-default">
                    <!-- Default panel contents BOOTSTRAP SAMPLE-->
                    <div class="panel-heading text-center">
                        <asp:Label ID="SummaryLabel" runat="server" Text="SUMMARY" Font-Bold="True" Font-Size="Larger" ForeColor="#F96C07"></asp:Label>
                    </div>
